        ...
        <div className="container">
            <div className="lg;grid lg;grid-cols-2">
                <div className="mb-10">
                    ...
                    <ButtonPrimary
                        href="mailto:youssefkammoun595@gmail.com"
                        label="Start project"
                        icon="chevron_right"
                        classes="reveal-up"
                    />
            ...
            <div className="flex items-center justify-between pt-10 mb-8">
                <a href="/" className="logo reveal-up">
                    <img src="/Henry Clark - Portfolio Images/images/logo.svg" width={40} height={40} alt="Logo" className="" />
                </a>
                <p className="text-zinc-500 text-sm reveal-up">
                    &copy;2025 <span className="text-zinc-200">Youssef Kammoun</span>
                </p>
            </div>
